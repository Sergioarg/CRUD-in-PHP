<?php
	...
	class UserController
	{
		...
		// Utilizo esta función para dirigirme la vista princial 
		...
		// FUNCION GUARDAR 
		// En esta funcion realizo el guardado del usuario en la BD
		...
		// FUNCION ACTUALIZAR
		// Por medio de esta funcion hago el llamado al modelo donde se encuentra respectivo el query.
		...
		//FUNCION ELIMINAR 
		// Por medio de esta funcion hago el llamado al modelo donde se encuentra el respectivo query. 
